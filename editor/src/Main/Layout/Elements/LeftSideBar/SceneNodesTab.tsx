...
export default function SceneNodesTab() {
  ...
  return (
    <section>
      ...
      <main>{mapNodes(sceneNodes, setSelectedSceneNode)}</main>
    </section>
  );
}

function mapNodes(
  nodes: SceneNode<"leaf" | "parent">[],
        ...
        return (
          <div key={node.label}>
            <p
              ...
              className={
                "p-1 pl-2 bg-gray-800 hover:bg-gray-700 transition-colors cursor-pointer"
              }
            >
              {node.label}
            </p>
    ...
    <div key={node.label}>
      ...
      >
        <span
          ...
          className={
            "bg-gray-800 hover:bg-gray-700 transition-colors p-1 w-6 text-center"
          }
        >
          {isOpen ? "-" : "+"}
        </span>
        <div
          className={
            "bg-gray-800 hover:bg-gray-700 transition-colors p-1 w-full pl-1.5"
          }
        >
          {node.label}
        </div>
